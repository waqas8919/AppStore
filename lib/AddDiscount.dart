...
import 'package:storeapp_taks/storelogo.dart';

class AddDiscountCodePage extends StatefulWidget {
  @override
  _MyHomePageState createState() => _MyHomePageState();
}

class _MyHomePageState extends State<AddDiscountCodePage> {
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: TextField(
                  ...
                  textAlignVertical: TextAlignVertical.bottom,
                  decoration: InputDecoration(
                      hintText: '%', hintStyle: TextStyle(color: Colors.black)),
                ),
              ),
              SizedBox(
                height: 20,
